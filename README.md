...
# 你可以:
1. **学习**或者拿来当**教学材料**都可以
2. 在非盈利性质的项目中使用，帮助他人理解或分享
3. 与朋友、同事共享，但仅限于**非商用**的场景
4. 在自己的博客、论坛、社交平台分享，但不得以**盈利**为目的
5. 喜欢的伙计记得点个Star~

# 你不可以,包括但不限于: 
1. 挂到**闲鱼等电商平台**上贩卖,特别是**某DN**, 老子最讨厌**二手码贩子**了
2. 将**源代码**其作为**产品**的一部分进行**商业化**或**变现**
3. 修改后用于**盈利**、**广告宣传**等**商业活动**
4. 声称为自己的**原创作品**，未经许可进行再分发或出售
