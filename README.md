 ...
 * @LastEditors: xixi_
 * @LastEditTime: 2025-08-17 21:55:32
...
# 代码规范
> 首先，使用`markdown编辑器`或者`具有markdown功能`的编辑器把`规范`完整的打一边, 然后, 全部删除掉, 不能按下Ctrl+Z, 立即关闭你的编辑器, 要彻底的删掉<br/>
> 然后呢, 现在可以开始了
1. 关键字
   - 禁止使用**auto**关键字
2. 缩进
   - if语句超过三层, 说明程序开始朝不好的方向发展, 需要修复, 请尝试使用**策略**, **卫语句**或者其他的方法来优化
   - 代码`必须`有缩进, 至少`4层缩进`, 因为`更大的缩进`可以让你很舒服
3. 变量名
