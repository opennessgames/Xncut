    ...
    : QWidget(Parent)
{
    ...
    /* 底部:工程视图 */
    M_AllProjectView = new XncutListView(); /* (全部的)工程视图 */
    /********************************************************************************************************/
    ...
    /* 底部:工程视图 */
    /* (全部的)工程视图 */
    M_AllProjectView->SetEmptyPixmap("://Images/Public/XEmpty.png", 600);
    M_AllProjectView->SetEmptyPixmapVisible(true);
    /********************************************************************************************************/
    ...
    M_MainLayout->addWidget(M_AllProjectView, 1, 0, 1, 8);
    /********************************************************************************************************/
