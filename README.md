 ...
 * @LastEditors: xixi_
 * @LastEditTime: 2026-06-07 13:06:18
...
敌人的**应试优势**只是**暂时** \
它们的欺凌更是**暂时** \
在**极端复杂**的**软件工程领域**中夺回来 \
它们**所谓应试优势, 死记硬背**在这里必将**脆弱不堪** \
让伟大**长期主义**胜利旗帜飞过我们头顶 \
**2023初三九班**侵略者必将**彻底失败** \
Под знаменем Ленина двигаться к победе
...
# 项目历史: 
> 2022年03月12日 初二时期, **熙柠游戏网站**立项, 标志着**熙柠系**的开始 \
> 2022年04月左右 **熙柠云剪辑**立项 \
> 2023年08月20日 Unity引擎版本创建 \
> 2023年11月04日 UE引擎(虚幻引擎)版本创建 \
> 2023年11月30日 QT版本创建, 现存, 很早期的C++入门项目, 也是我的第一个Qt项目。 \
> 2024年04月03日 23时52分46秒 开始设计欢迎界面图片
> 2024年04月07日 16时28分25秒 欢迎界面图片设计完成
> 2025年07月14日 16时54分37秒 纯UI版分支创建

# 重要消息:
1. 目前还在实现一些底层所需要的, 包括一些些小框架, 所以这个仓库将会很长一段时间不更新, 希望您知道
2. [已放弃] 我尝试只使用Qt的**QWidget模块**, 其余的一律不用, 属性, 哈希表, 队列, 动态容器等等都是自己使用C语言实现的
  - 为什么放弃? 拆黑盒自己实现不是很可靠,  还是用QT提供的模块吧。 
3. 暂时先基于shotcut研发, 当前可用的熙柠剪辑**fork**自**shotcut**, 是shotcut的衍生品, 逐一摸透后再自研, 避免**盲人摸象**, 因为网上精讲NLE底层资料的实在太少了, 啊啊啊啊啊啊啊啊啊啊!
