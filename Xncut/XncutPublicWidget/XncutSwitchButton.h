 ...
 * @LastEditors: xixi_
 * @LastEditTime: 2025-07-06 20:05:38
 * @FilePath: /Xncut/Xncut/XncutPublicWidget/XncutSwitchButton.h
 * Copyright (c) 2020-2025 by xixi_ , All Rights Reserved.
 */

#ifndef XNCUT_SWITCH_BUTTON_H
#define XNCUT_SWITCH_BUTTON_H
...
class XncutSwitchButton : public QWidget
{
    Q_OBJECT
public:
    enum ButtonStyle
    ...
    XncutSwitchButton(QWidget *Parent = NULL);
    ~XncutSwitchButton();
