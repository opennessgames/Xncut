 ...
 * @LastEditors: xixi_
 * @LastEditTime: 2025-09-28 00:12:51
 * @FilePath: /Xncut/Test/XncutPenTool/XncutPenTool/XncutPenToolCoreWidget/XncutPenToolWidget2.h
 * Copyright (c) 2020-2025 by xixi_ , All Rights Reserved.
 */

#ifndef XNCUT_PEN_TOOL_WIDGET_2_H
#define XNCUT_PEN_TOOL_WIDGET_2_H

#include <QWidget>

/**
 * TODO: 代码可能是很糟糕的, 可以将拆分成钢笔模型和钢笔视图
 * TODO: 然后可以考虑通过`非递归`K-D树优化
 * TODO: 可以尝试推广到N阶贝塞尔曲线
 *
 * 快捷键方案1
 * 1. 鼠标点击 添加点
...
class XncutPenToolWidget2 : public QWidget
{
    Q_OBJECT
private:
    /**
...
public:
    explicit XncutPenToolWidget2(QWidget *Parent = NULL);
    ~XncutPenToolWidget2();
    /********************************************************************************************************/
...
#endif // XNCUT_PEN_TOOL_WIDGET_2_H
