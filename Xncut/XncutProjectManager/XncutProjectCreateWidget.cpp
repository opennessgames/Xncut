    ...
    : QWidget(Parent)
{
    ...
    M_ProxyClipSwitchButton = new XncutSwitchButton(); /* 代理剪辑滑动开关 */
    M_CopyClipSwitchButton = new XncutSwitchButton();  /* 复制剪辑滑动开关 */
    M_AutoSaveLayout = new QHBoxLayout();              /* 自动保存布局 */
    M_AutoSaveSwitchButton = new XncutSwitchButton();  /* 自动保存滑动开关 */
    ...
    /* 代理剪辑 */
    M_ProxyClipSwitchButton->setFixedSize(90, 35);
    M_ProxyClipSwitchButton->setText("开启", "关闭");
    /* 复制剪辑 */
    M_CopyClipSwitchButton->setFixedSize(90, 35);
    M_CopyClipSwitchButton->setText("开启", "关闭");
    /* 自动保存 */
    M_AutoSaveSwitchButton->setFixedSize(90, 35);
    M_AutoSaveSwitchButton->setText("开启", "关闭");
    /* 自动保存秒数行编辑框 */
...
的色彩信息.未来,我们将支持更多位深度的格式.)"));
    ...
    /* 自动保存布局 */
    M_AutoSaveLayout->addWidget(M_AutoSaveSwitchButton, 0);
    ...
    M_AdvancedFormLayout->addRow(new QLabel("代理剪辑"), M_ProxyClipSwitchButton);
    M_AdvancedFormLayout->addRow(new QLabel("复制剪辑"), M_CopyClipSwitchButton);
